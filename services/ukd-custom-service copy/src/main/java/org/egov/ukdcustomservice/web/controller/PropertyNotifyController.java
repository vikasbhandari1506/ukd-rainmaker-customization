...
@Slf4j
public class PropertyNotifyController {

    @Autowired
    private Producer producer;

    private static final Logger log = org.slf4j.LoggerFactory.getLogger(PropertyNotifyController.class);

    @GetMapping
    public String notifyPT() {
        ...
        for (int i = 0; i < 1000000; i++) {
            mobile = mobile - i;
            sms.setMobileNumber(String.valueOf(mobile));
            sms.setMessage("Mobile number : " + String.valueOf(mobile));
