package org.egov.ukcustomservice.web.controller;
...
@Controller
@Slf4j
public class EasyPayRedirectController {

    @Value("${egov.default.citizen.url}")
    private String defaultURL;

    @Value("${egov.return.url.key:originalreturnurl}")
    private String returnUrlKey;

    @RequestMapping(value = "/payment/redirect", method = RequestMethod.POST, consumes = MediaType.APPLICATION_FORM_URLENCODED_VALUE)
